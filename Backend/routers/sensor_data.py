...
def add_sensor_data(request_body: schemas.SensorDataSchema, db: Session = Depends(get_db)):
    sensor = db.get(models.Sensor, request_body.sensor_id)
    ...
    return {"message": "Sensor data added successfully", "data": sensor_data}
